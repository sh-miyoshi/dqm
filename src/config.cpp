...
CKey::CKey(){
	...
	IsAbleToOpenFile(ifs.good(), "CKey::Ckey()", CODE_TABLE_FILE_NAME);
	std::string buf;
	...
	if( ifs ){
		...
		keyInfo[eKEY_DEBUG_B] = KEY_INPUT_B;
		keyInfo[eKEY_DEBUG_E] = KEY_INPUT_E;
		keyInfo[eKEY_DEBUG_S]=KEY_INPUT_S;
	}
}
